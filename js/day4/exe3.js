...
function trierProduits(catalogue,cle,ordre){
    switch(ordre){
        case 'ASC':
            let catAsc=catalogue.sort((a,b)=>a[cle] - b[cle]);
            return console.log(catAsc);
           
            case 'DESC':
                 let catDesc=catalogue.sort((a,b)=> b[cle] - a[cle]);
            return console.log(catDesc);
...
trierProduits(catalogue,'nom',"DESC")
